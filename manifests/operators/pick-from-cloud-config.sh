...
# The base manifests/cfsummit.yml assumes that your `bosh cloud-config` contains
...
#
# Usage:
#   bosh deploy manifests/cfsummit.yml -o <(./manifests/operators/pick-from-cloud-config.sh)
